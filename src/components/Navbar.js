  ...
  <div className="container-fluid">
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      <ul className="navbar-nav me-auto mb-2 mb-lg-0">
       ...
       {/*<li className="nav-item">
          <a className={`nav-link text-${props.mode==='light'?'dark':'light'}`} href="\">{props.aboutTextUtils}</a>
  </li>*/}
    ...
    <div className={`form-check form-switch me-4 text-${props.change==='light'?'dark':'warning'}`}>
  <input className="form-check-input" type="checkbox" onClick={props.yellowmode} role="switch" id="flexSwitchCheckDefault"/>
  <label className="form-check-label" htmlFor="flexSwitchCheckDefault">Enable yellow mode</label>
</div>

  <div className={`form-check form-switch me-4 text-${props.change==='light'?'dark':'danger'}`}>
